...
<div class="col-sm">
    <div class="container-fluid welcome my-3 ms-5" style="border-radius:15px; width:85%; height:98%;">        <div class="container-fluid p-4 my-2" style="width:85%">	
...
<script>
  ...
  /*  This the function to open the sidebar by setting  the width to 300 px and the main margin to 300px*/
  function openNav() {
