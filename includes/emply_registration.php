...
$page_title = "Employee Registration ~ Tiny Paws Account";
?>
...
.invalid:before {
  ...
  content: "?";
    ...
    <!--This is the h3 heading the employee login page for the employee to sign up for an account  with the registration link with a pawprint to the right-->
	<h3>Employee Registration <i style="font-size:25px" class="fa"> &#xf1b0;</i></h3>

            <!--This is the form for the employee registration signup page inside of a paragraph with the label and input boxes with pattern, title and 
            required validation -->
            <p>
            <form action="employee.php?name=emply_registrationComplete" method="POST" style="font-family: Roboto, Helvetica, sans-serif">
		...
		<label style="margin:5px 20px 8px 0px">Confirm <br>Password: </label><input type="password"  name="confirm_password" id="confirm_password" onchange="myFunction()" style="border:2px solid black" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Confirm Password" required><br><br>
