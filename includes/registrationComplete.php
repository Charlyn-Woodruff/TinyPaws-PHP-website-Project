...
# File document: registrationComplete.php
/* Date: Sept 25, 2024
...
if(getUserByUserName($_POST['username'])){
...
if(!$errors){
    echo "<h3>Thank you for signing up! <i style='font-size:25px' class='fa'>&#xf1b0;</i></h3> ";   
 	echo "<p> You may now login to your Tiny Paws Account in the side Bar menu!</p><br>";
	echo "<h4>Customer account created successfully!</h4>";	
	registerCust($_POST);
}else{

    echo "<h4 style='color:red'>Customer Registration Unsuccessful!</h4>";
