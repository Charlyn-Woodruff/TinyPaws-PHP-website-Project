...
# File document: petUpdateForm.php
/* Date:Nov 15, 2024
...
$page_title = "Pet UpDate Form";
?>
    <!--This is the h3 heading for the pet updated webpage with a pawprint to the right-->
	<h3>Update Your Pet's Information<i style="font-size:25px" class="fa"> &#xf1b0;</i></h3>

        <!--This is the form for the customer to update their pets information using the hidden customers session id with the label and input boxes with pattern, title and 
        required validation -->
        <p>Enter the name of the pet you want to update</p>

        <form action="index.php?name=petUpdated" method="POST" style="font-family: Roboto, Helvetica, sans-serif">
	    <input type="hidden" value="<?php echo $_SESSION['user_id']; ?>" name="user_id">
            <label style="margin:5px 21px 8px 0px">Pet's Name: </label><input type="text" name="petName" style="border:2px solid black" title="Enter valid Name" pattern="[A-Za-z ]{1,25}" placeholder=" Pet Name" required><br>
