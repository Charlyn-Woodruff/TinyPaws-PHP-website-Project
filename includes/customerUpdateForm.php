...
# File document: customerUpdateForm.php
/* Date: Sept 25, 2024
...
$page_title = "Update User Information ~ Tiny Paws Accounts"; 
?>
    <!--This is the h3 heading for the update User form page--> 
    <h3> Update User Account</h3>
    <p>
	<!--This is the form to get all the information from the user to updat their information and calls the action page customerUpdated--> 
        <form action="index.php?name=customerUpdated" method="POST" style="font-family: Roboto, Helvetica, sans-serif">
