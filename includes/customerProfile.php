...
# File document: customerProfile.php
/* Date: Nov 19, 2024
...
?>
    ...
    <h3>Customer Account Information <i style="font-size:25px" class="fa"> &#xf1b0;</i></h3>

	<!--This is the form that uses the session user id in a hidden input--> 
	<form action="index.php?name=customerProfile" method="POST" style="font-family: Roboto, Helvetica, sans-serif">
	...
	$customer_id =$_SESSION['user_id'];
		getCustById($customer_id);
		getCustPets($customer_id);
	?>