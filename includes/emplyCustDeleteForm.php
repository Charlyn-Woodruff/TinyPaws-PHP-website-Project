...
# File document: emplyCustDeleteForm.php
/* Date: Sept 25, 2024
...
$page_title = "Delete Customer Account ~ Tiny Paws Accounts"; 
?>
	...
	<form action="employee.php?name=customerDeleted" method="POST" style="font-family: Roboto, Helvetica, sans-serif">
	    <label style="margin:5px 5px 8px 0px">Customer Id: </label><input type="text" name="user_id" style="border:2px solid black" title="Enter Employee Id" pattern="[0-9]{1,25}" placeholder="Enter Customer Id" required><br><br>
